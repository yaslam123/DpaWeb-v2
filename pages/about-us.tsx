...
import { GiFairyWings, GiInjustice } from 'react-icons/gi';
...
const Aboutus = () => {
    ...
    return (
        <div>
            <Head>
                <Link href="/about-us">More about DPA...</Link>
            </Head>
                ...
                <div className="container relative z-[1]">
                    <div className="text-center lg:w-1/2 ltr:lg:text-left rtl:lg:text-right">
                        <div className="heading mb-5 text-center ltr:lg:text-left rtl:lg:text-right xl:w-[95%]">
                            <h6>Who are we?</h6>
                            <h4>
                                Data Protection <br /> Authority - <span className="text-secondary">Somali </span>
                            </h4>
                        </div>
                        <p className="text-justify text-lg font-semibold leading-[30px] text-black">
                            Somali Data Protection Authority (DPA) is the national independent authority responsible for protecting personal privacy and
                            monitoring that all organizations are compliant with the Data Protection Act (no.005 which was passed in March 2023). The role of
                            DPA is to implement the Data Protection Act, as well as providing services that facilitate protection of personal data, such as;
                            awareness campaigns, registration, trainings, creating and passing regulations specific to storing and processing data.
                        </p>
                        <p className="text-justify text-lg font-semibold leading-[30px] text-black">
                            All citizens have the right to the privacy of their personal data, and that is a fundamental right. The Data Protection Authority
                            has been entrusted by the federal government of Somalia to safeguard that right, and is responsible for ensuring compliance with the
                            Data Protection Act. The Act gives citizens’ the autonomy to decide how their data is processed, used and who it is shared with.
                        </p>
                    </div>
                </div>
            ...
            <section className="relative py-14 lg:py-[100px] xl:-mt-[100px]">
                ...
                <div className="container relative z-[2] ltr:xl:pr-40 rtl:xl:pl-40">
                    <div className="heading mb-8 text-center ltr:lg:text-left rtl:lg:text-right">
                        <h4 className="text-[12px]">How it works</h4>
                    </div>
                            ...
                            >
                                ...
                                <div>
                                    ...
                                    <ol className="text-[15px] font-semibold text-black dark:text-gray">
                                        ...
                                        <li className=" mb-2"> - Integrity & Confidentiality</li>
                                        <li className=" mb-2"> - Data Governance Ethics</li>
                                    </ol>
                                </div>
                            </div>
                        </div>
                        ...
                        <div className="group">
                            ...
                            <div className="relative mx-4 -mt-10 space-y-2.5 bg-gray-dark px-4 pt-[22px] text-center dark:bg-black md:px-[26px]">
                                ...
                                <p className="pb-[60px] text-left text-lg font-semibold">
                                    The Data Protection Authority (DPA) in Somalia regulates and oversees data protection, ensuring that organizations and
                                    entities adhere to established guidelines and laws governing the responsible handling of personal information.
                                </p>
                    ...
                    >
                        <div className="text-center sm:text-left">
                            <span className="inline-block">
                                <GiInjustice className="mx-auto text-4xl text-primary sm:mx-0 sm:text-left" />
                            </span>
                        ...
                        <div className="text-center sm:text-left">
                            ...
                            <h5 className="mt-5 text-lg font-extrabold text-black dark:text-white">Data Minimization</h5>
